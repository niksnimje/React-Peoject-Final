    ...
    <>
      <Navbar bg="light" expand="lg" className="mb-5 position-sticky top-0 z-3">
        <Container fluid>
          ...
          <Nav className="me-auto d-none d-sm-none d-md-none d-lg-none d-xl-block">
          ...
          <Navbar.Collapse id="basic-navbar-nav" className="d-none d-lg-block">
            ...
            <Nav className="ms-auto">
              ...
              <Nav.Link as={NavLink} to="/account"><FaUser /></Nav.Link>
              <Nav.Link as={NavLink} to="/cart"><FaShoppingCart /></Nav.Link>
            </Nav>
          </Navbar.Collapse>
        </Container>
      ...
      <Offcanvas show={show} onHide={handleClose} placement="start">
        ...
        <Offcanvas.Body>
          <Nav className="flex-column">
            ...
            <Nav.Link as={NavLink} to="/cart" onClick={handleClose}><FaShoppingCart /> Cart</Nav.Link>
          </Nav>
        </Offcanvas.Body>
      </Offcanvas>
    </>
